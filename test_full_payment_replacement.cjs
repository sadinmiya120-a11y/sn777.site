...
let replacement = `xs?o.jsx(ce.div,{initial:{opacity:0,scale:.98},animate:{opacity:1,scale:1},exit:{opacity:0,scale:.98},className:"sn-pay-page-wrapper",style:{backgroundColor:"#ffffff",minHeight:"100vh"},children:` +
...
const wrapped = "function test() { return (" + replacement + " : false); }";
