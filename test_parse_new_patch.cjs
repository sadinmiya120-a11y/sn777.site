...
let exactScreenshotPaymentScreen = `xs?o.jsx(ce.div,{initial:{opacity:0,scale:.98},animate:{opacity:1,scale:1},exit:{opacity:0,scale:.98},className:"sn-pay-page-wrapper",children:` +
  `o.jsxs("div",{className:"sn-pay-card",children:[` +
    // Top green bar (#00684a)
    `o.jsxs("div",{className:"sn-pay-topbar",children:[` +
      `o.jsxs("div",{className:"sn-pay-topbar-row",children:[` +
        `o.jsxs("div",{children:[` +
          `o.jsxs("div",{className:"sn-pay-amount-title",children:["BDT ",parseFloat(Is||ys||"306").toFixed(2)]}),` +
          `o.jsx("div",{className:"sn-pay-amount-desc",children:"কম বা বেশি টাকা পাঠাবেন না"})` +
        `]}),` +
        `o.jsxs("div",{className:"sn-pay-topbar-right",children:[` +
          `o.jsx("button",{type:"button",onClick:()=>Ls(!1),className:"sn-pay-service-btn",children:"PAY SERVICE"}),` +
          `o.jsxs("div",{className:"sn-pay-lang-container",children:[` +
            `o.jsx("span",{className:"sn-pay-lang-badge",children:"EN"}),` +
            `o.jsx("span",{className:"sn-pay-lang-badge",children:"বাংলা"})` +
          `]})` +
        `]})` +
      `]})` +
    `]}),` +
    ...
    `o.jsx("div",{className:"sn-pay-pink-alert-wrap",children:` +
      `o.jsxs("div",{className:"sn-pay-pink-alert",children:[` +
    ...
    `o.jsxs("div",{className:"sn-pay-brand-banner "+(Be==="nagad"?"sn-pay-banner-nagad":Be==="rocket"?"sn-pay-banner-rocket":"sn-pay-banner-bkash"),children:[` +
      `o.jsxs("div",{className:"sn-pay-banner-left",children:[` +
        `o.jsx("div",{className:"sn-pay-brand-logo-box",children:` +
          `o.jsx("img",{src:(Bi.find(E=>E.id===Be))?.logo||Bi[0].logo,alt:Be,className:"sn-pay-brand-logo-img"})` +
        `}),` +
        `o.jsxs("div",{className:"sn-pay-brand-title",children:[` +
    ...
    `o.jsx("div",{className:"sn-pay-sendmoney-wrap",children:` +
      `o.jsx("div",{className:"sn-pay-sendmoney-card",children:` +
        `o.jsxs("div",{children:[` +
    ...
    `o.jsx("div",{className:"sn-pay-number-wrap",children:` +
      `o.jsxs("div",{className:"sn-pay-number-box",children:[` +
        `o.jsx("span",{className:"sn-pay-number-text",children:Ys}),` +
        `o.jsxs("button",{type:"button",onClick:()=>Z(Ys,"agent"),className:"sn-pay-copy-btn",children:[` +
          `o.jsx(ih,{size:16}),` +
    ...
    `o.jsx("div",{className:"sn-pay-trx-input-wrap",children:` +
      `o.jsx("input",{type:"text",value:oi,onChange:E=>Xt(E.target.value),className:"sn-pay-trx-input",placeholder:"TrxID লিখুন"})` +
    `}),` +

    // Warning Notice Box
    `o.jsx("div",{className:"sn-pay-warning-wrap",children:` +
      `o.jsxs("div",{className:"sn-pay-warning-box",children:[` +
        `o.jsx("div",{className:"sn-pay-warning-title",children:"সতর্কতা:"}),` +
        `o.jsx("div",{className:"sn-pay-warning-desc",children:"লেনদেন আইডি সঠিকভাবে পূরণ করতে হবে, অন্যথায় ক্রেডিট ব্যর্থ হবে!!"})` +
      `]})` +
    `}),` +

    // Submit Button (জমা দিন)
    `o.jsx("div",{className:"sn-pay-submit-wrap",children:` +
      `o.jsx("button",{type:"button",onClick:v,disabled:Ee,className:"sn-pay-submit-btn "+(Be==="nagad"?"sn-pay-btn-nagad":Be==="rocket"?"sn-pay-btn-rocket":"sn-pay-btn-bkash"),children:` +
...
console.log("Parsing test with acorn...");
